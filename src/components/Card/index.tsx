...
export const ExperienceCard = ({ title, company, startDate, endDate, description, skills, url }: ExperienceCardProps) => (
    <div className="group relative transition-all lg:hover:!opacity-100 lg:group-hover/list:opacity-50 border-[1px] rounded-lg border-transparent hover:border-sky-400/40">
        <a className="m-3 grid pb-1 sm:grid-cols-12 sm:gap-8" href={url}>
            <header className="mt-1 col-span-4 text-xs uppercase tracking-wide text-slate-500">{startDate} — {endDate}</header>
